        ...
        <div className="banner">
          <div className="firstBox">
            ...
            <div className="content">
              ...
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. A et voluptates fugiat eos error nostrum, magni vitae, libero impedit similique rem delectus ut fugit aperiam?
              </p>
            </div>
          </div>
                  ...
                  appointments.map(appointment => {
                    return (
                      <tr key={appointment._id}>
                        ...
                        <td>{appointment.hasVisted === true ? <GoCheckCircleFill className='green' /> : <AiFillCloseCircle className='red' />}</td>
                      </tr>
                    )
                  })
